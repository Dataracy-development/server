...
class EmailVerificationTypeTest {
    ...
    class OfMethod {
        ...
        @Test
        @DisplayName("대소문자 무시하고 value/name 모두 인식한다")
        void convertsStringIgnoringCase() {
            // given
        ...
        @Test
        @DisplayName("정의되지 않은 값이면 EmailException(INVALID_EMAIL_SEND_TYPE)")
        void throwsOnInvalidValue() {
            // given
