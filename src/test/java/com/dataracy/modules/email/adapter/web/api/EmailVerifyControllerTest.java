...
class EmailVerifyControllerTest {
  ...
  @Spy private ValidateEmailWebMapper mapper = new ValidateEmailWebMapper();

  @Mock private VerifyEmailUseCase useCase;

  @InjectMocks private EmailVerifyController controller;
