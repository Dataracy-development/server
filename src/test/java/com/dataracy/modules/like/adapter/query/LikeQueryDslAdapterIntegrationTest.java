...
class LikeQueryDslAdapterIntegrationTest {
  ...
  @Autowired private LikeQueryDslAdapter likeAdapter;
  ...
  class ReadLikePortTest {
    ...
    void findLikedTargetIds_사용자_좋아요_타겟_ID_목록_조회_성공() {
      ...
      // then
      assertAll(() -> assertThat(result).hasSize(1), () -> assertThat(result).contains(1L));
    }
  ...
  class DifferentTargetTypesTest {
    ...
    void project_target_like_test() {
      ...
      List<Long> likedTargets =
          likeAdapter.findLikedTargetIds(1L, List.of(1L, 2L), TargetType.PROJECT);
    ...
    void comment_target_like_test() {
      ...
      List<Long> likedTargets =
          likeAdapter.findLikedTargetIds(1L, List.of(1L, 2L), TargetType.COMMENT);
  ...
  class ComplexScenarioTest {
    ...
    void one_user_likes_multiple_targets() {
      ...
      List<Long> projectLikes =
          likeAdapter.findLikedTargetIds(1L, List.of(1L, 2L, 3L), TargetType.PROJECT);
      List<Long> commentLikes =
          likeAdapter.findLikedTargetIds(1L, List.of(1L, 2L, 3L), TargetType.COMMENT);
