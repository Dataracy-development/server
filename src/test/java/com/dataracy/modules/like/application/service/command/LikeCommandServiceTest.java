...
class LikeCommandServiceTest {
    ...
    @Mock
    private SendLikeEventPort sendLikeEventPort;

    @Mock
    private ValidateProjectUseCase validateProjectUseCase;

    @Mock
    private ValidateCommentUseCase validateCommentUseCase;
