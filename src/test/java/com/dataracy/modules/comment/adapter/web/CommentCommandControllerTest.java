...
class CommentCommandControllerTest {
    ...
    void uploadCommentSuccess() throws Exception {
        ...
        given(commandCommentWebMapper.toApplicationDto(any(UploadCommentWebRequest.class))).willReturn(appReq);
    ...
    void modifyCommentSuccess() throws Exception {
        ...
        given(commandCommentWebMapper.toApplicationDto(any(ModifyCommentWebRequest.class))).willReturn(appReq);
