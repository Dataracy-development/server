package com.dataracy.modules.comment.adapter.web;
...
class CommentReadControllerTest {
    ...
    void findCommentsSuccess() throws Exception {
        FindCommentResponse appRes = new FindCommentResponse(1L,"닉네임","등급","url","내용",0L,0L, LocalDateTime.now(),false);
        FindCommentWebResponse webRes = new FindCommentWebResponse(1L,"닉네임","등급","url","내용",0L,0L, LocalDateTime.now(),false);
    ...
    void findReplyCommentsSuccess() throws Exception {
        FindReplyCommentResponse appRes = new FindReplyCommentResponse(2L,"닉네임","등급","url","내용",0L, LocalDateTime.now(),false);
        FindReplyCommentWebResponse webRes = new FindReplyCommentWebResponse(2L,"닉네임","등급","url","내용",0L, LocalDateTime.now(),false);
