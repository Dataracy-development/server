...
class CommentStatusTest {
    ...
    void errorStatusValues() {
        assertAll(
                ...
                () -> assertThat(CommentErrorStatus.NOT_FOUND_COMMENT.getMessage()).isEqualTo("해당 피드백 댓글 리소스가 존재하지 않습니다.")
        );
    }
    ...
    void successStatusValues() {
        assertAll(
                ...
                () -> assertThat(CommentSuccessStatus.CREATED_COMMENT.getMessage()).isEqualTo("댓글 작성이 완료되었습니다")
        );
    }
}
