...
class CommentSuccessStatusTest {
  ...
  void commentSuccessStatuses_ShouldHaveCorrectHttpStatus() {
    ...
    assertAll(
        ...
        () ->
            assertThat(CommentSuccessStatus.MODIFY_COMMENT.getHttpStatus())
                .isEqualTo(HttpStatus.OK),
        () ->
            assertThat(CommentSuccessStatus.DELETE_COMMENT.getHttpStatus())
                .isEqualTo(HttpStatus.OK),
        () ->
            assertThat(CommentSuccessStatus.GET_COMMENTS.getHttpStatus()).isEqualTo(HttpStatus.OK),
        () ->
            assertThat(CommentSuccessStatus.GET_REPLY_COMMENTS.getHttpStatus())
                .isEqualTo(HttpStatus.OK));
  }
  ...
  void commentSuccessStatuses_ShouldHaveCorrectMessage() {
    ...
    assertAll(
        ...
        () ->
            assertThat(CommentSuccessStatus.GET_COMMENTS.getMessage())
                .contains("댓글 목록 조회가 완료되었습니다"),
        () ->
            assertThat(CommentSuccessStatus.GET_REPLY_COMMENTS.getMessage())
                .contains("답글 목록 조회가 완료되었습니다"));
  }
}
