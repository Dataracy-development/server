...
class CommentUserInfoServiceTest {
    ...
    class FindCommentUserInfoBatch {
        ...
        void findCommentUserInfoBatchSuccess() {
            ...
            Map<Long, String> authorLevelIdsMap = Map.of(
                    1L, "10",
                    2L, "20",
                    3L, "10"
            );
            Map<Long, String> authorLevelLabelMap = Map.of(
                    10L, "Beginner",
                    20L, "Intermediate"
            );
            ...
            given(findUserAuthorLevelIdsUseCase.findUserAuthorLevelIds(userIds)).willReturn(authorLevelIdsMap);
        ...
        void findCommentUserInfoBatchWithDuplicates() {
            ...
            given(findUserAuthorLevelIdsUseCase.findUserAuthorLevelIds(any())).willReturn(authorLevelIdsMap);
            given(getAuthorLevelLabelFromIdUseCase.getLabelsByIds(any())).willReturn(authorLevelLabelMap);
