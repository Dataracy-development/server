...
class ExtractCommentServiceTest {
  ...
  @Mock private ExtractCommentPort extractCommentPort;

  @InjectMocks private ExtractCommentService service;
    ...
    void findUserIdShouldThrowWhenCommentNotFound() {
      ...
      CommentException ex =
          catchThrowableOfType(
              () -> service.findUserIdByCommentId(commentId), CommentException.class);
