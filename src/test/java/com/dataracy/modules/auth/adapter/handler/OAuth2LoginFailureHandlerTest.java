...
class OAuth2LoginFailureHandlerTest {
  ...
  @InjectMocks private OAuth2LoginFailureHandler oAuth2LoginFailureHandler;
  ...
  void onAuthenticationFailure_WhenNullResponse_HandlesCorrectly() {
    ...
    thenThrownBy(
            () ->
                oAuth2LoginFailureHandler.onAuthenticationFailure(request, nullResponse, exception))
