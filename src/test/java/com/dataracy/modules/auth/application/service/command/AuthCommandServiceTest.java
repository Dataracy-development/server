...
class AuthCommandServiceTest {
  ...
  @Mock private IsLoginPossibleUseCase isLoginPossibleUseCase;
  ...
  class LoginWithRateLimitTest {
    ...
    void loginWithRateLimitSuccess() {
      ...
      given(isLoginPossibleUseCase.checkLoginPossibleAndGetUserInfo(anyString(), anyString()))
          .willReturn(userInfo);
    ...
    void loginWithRateLimitFailWhenRateLimitExceeded() {
      ...
      AuthException exception =
          catchThrowableOfType(
              () -> service.loginWithRateLimit(request, clientIp), AuthException.class);
      assertAll(
      ...
      assertAll(
          ...
          () ->
              assertThat(exception.getErrorCode())
                  .isEqualTo(AuthErrorStatus.EXPIRED_REFRESH_TOKEN));
    }
