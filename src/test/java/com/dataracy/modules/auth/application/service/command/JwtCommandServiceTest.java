...
class JwtCommandServiceTest {
  ...
  @InjectMocks private JwtCommandService service;
  ...
  class GenerateResetPasswordToken {
    ...
    @DisplayName("성공 - 토큰 생성 성공 시 그대로 반환")
    void success() {
      given(jwtTokenGenerator.generateResetPasswordToken("user@test.com")).willReturn("resetToken");
    ...
    void fail() {
      ...
      AuthException ex =
          catchThrowableOfType(
              () -> service.generateResetPasswordToken("user@test.com"), AuthException.class);
  ...
  class GenerateAccessToken {
    ...
    void fail() {
      ...
      AuthException ex =
          catchThrowableOfType(
              () -> service.generateAccessToken(1L, RoleType.ROLE_USER), AuthException.class);
  ...
  class GenerateRefreshToken {
    ...
    void fail() {
      ...
      AuthException ex =
          catchThrowableOfType(
              () -> service.generateRefreshToken(1L, RoleType.ROLE_USER), AuthException.class);
