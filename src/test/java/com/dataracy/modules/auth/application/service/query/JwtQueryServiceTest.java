...
class JwtQueryServiceTest {
    ...
    class ValidateToken {
        ...
        void success() {
            ...
            // 로깅 검증
            then(loggerService).should().logStart(eq("JwtValidateUseCase"), 
                contains("토큰 유효성 검사 서비스 시작"));
            then(loggerService).should().logSuccess(eq("JwtValidateUseCase"), 
                contains("토큰 유효성 검사 서비스 성공"), any(Instant.class));
        }
    ...
    class GetUserIdFromToken {
        ...
        void success() {
            ...
            // 로깅 검증
            then(loggerService).should().logStart(eq("JwtValidateUseCase"), 
                contains("토큰으로부터 유저 아이디 추출 서비스 시작"));
            then(loggerService).should().logSuccess(eq("JwtValidateUseCase"), 
                contains("토큰으로부터 유저 아이디 추출 서비스 성공"), any(Instant.class));
        }
    ...
    class GetRoleFromToken {
        ...
        void success() {
            ...
            // 로깅 검증
            then(loggerService).should().logStart(eq("JwtValidateUseCase"), 
                contains("토큰으로부터 유저 role 추출 서비스 시작"));
            then(loggerService).should().logSuccess(eq("JwtValidateUseCase"), 
                contains("토큰으로부터 유저 role 추출 서비스 성공"), any(Instant.class));
        }
    }
    ...
    class GetTokenExpirationTime {
        ...
        void getAccessTokenExpirationTimeSuccess() {
            ...
            // 로깅 검증
            then(loggerService).should().logStart(eq("JwtValidateUseCase"), 
                contains("어세스 토큰 유효기간 반환 서비스 시작"));
            then(loggerService).should().logSuccess(eq("JwtValidateUseCase"), 
                contains("어세스 토큰 유효기간 반환 서비스 성공"), any(Instant.class));
        }
        ...
        void getRefreshTokenExpirationTimeSuccess() {
            ...
            // 로깅 검증
            then(loggerService).should().logStart(eq("JwtValidateUseCase"), 
                contains("리프레시 토큰 유효기간 반환 서비스 시작"));
            then(loggerService).should().logSuccess(eq("JwtValidateUseCase"), 
                contains("리프레시 토큰 유효기간 반환 서비스 성공"), any(Instant.class));
        }
    }
    ...
    class GetRedirectUrls {
        ...
        void getRedirectOnboardingUrlSuccess() {
            ...
            // 로깅 검증
            then(loggerService).should().logStart(eq("JwtValidateUseCase"), 
                contains("소셜 회원가입 시 추가정보 입력을 위한 온보딩 url 반환 서비스 시작"));
            then(loggerService).should().logSuccess(eq("JwtValidateUseCase"), 
                contains("소셜 회원가입 시 추가정보 입력을 위한 온보딩 url 반환 서비스 성공"), any(Instant.class));
        }
        ...
        void getRedirectBaseUrlSuccess() {
            ...
            // 로깅 검증
            then(loggerService).should().logStart(eq("JwtValidateUseCase"), 
                contains("로그인, 회원가입 완료 후 이동하는 메인 url 반환 서비스 시작"));
            then(loggerService).should().logSuccess(eq("JwtValidateUseCase"), 
                contains("로그인, 회원가입 완료 후 이동하는 메인 url 반환 서비스 성공"), any(Instant.class));
        }
    }
}