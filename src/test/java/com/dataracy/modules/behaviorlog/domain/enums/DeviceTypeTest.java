...
class DeviceTypeTest {
  ...
  void deviceType_ShouldResolveFromUserAgent() {
    ...
    assertAll(
        ...
        () ->
            assertThat(DeviceType.resolve("Mozilla/5.0 (iPhone; CPU iPhone OS 14_0 like Mac OS X)"))
                .isEqualTo(DeviceType.MOBILE),
        () ->
            assertThat(DeviceType.resolve("Mozilla/5.0 (iPad; CPU OS 14_0 like Mac OS X)"))
                .isEqualTo(DeviceType.TABLET),
        () ->
            assertThat(DeviceType.resolve("Mozilla/5.0 (Windows NT 10.0; Win64; x64)"))
                .isEqualTo(DeviceType.PC),
        () ->
            assertThat(DeviceType.resolve("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)"))
                .isEqualTo(DeviceType.PC),
        () ->
            assertThat(DeviceType.resolve("Mozilla/5.0 (Linux; Android 10)"))
                .isEqualTo(DeviceType.MOBILE),
