...
class ProjectSearchControllerTest {
    ...
    void searchRealTimeProjectsSuccess() throws Exception {
        ...
        RealTimeProjectResponse response1 = new RealTimeProjectResponse(
                1L, "AI Project 1", 1L, "User 1", "profile1.jpg", "thumb1.jpg"
        );
        RealTimeProjectResponse response2 = new RealTimeProjectResponse(
                2L, "AI Project 2", 2L, "User 2", "profile2.jpg", "thumb2.jpg"
        );
        List<RealTimeProjectResponse> responseList = List.of(response1, response2);

        RealTimeProjectWebResponse webResponse1 = new RealTimeProjectWebResponse(
                1L, "AI Project 1", 1L, "User 1", "profile1.jpg", "thumb1.jpg"
        );
        ...
        mockMvc.perform(get("/api/v1/projects/search/real-time")
                ...
                .andExpect(jsonPath("$.message").value(ProjectSuccessStatus.FIND_REAL_TIME_PROJECTS.getMessage()))
    ...
    void searchSimilarProjectsSuccess() throws Exception {
        ...
        SimilarProjectResponse response1 = new SimilarProjectResponse(
                2L, "Similar Project 1", "Content 1", 1L, "User 1", "profile1.jpg", "thumb1.jpg",
                "AI", "Research", "Public", "Expert", 10L, 5L, 100L
        );
        SimilarProjectResponse response2 = new SimilarProjectResponse(
        ...
        SimilarProjectWebResponse webResponse1 = new SimilarProjectWebResponse(
                2L, "Similar Project 1", "Content 1", 1L, "User 1", "profile1.jpg", "thumb1.jpg",
                "AI", "Research", "Public", "Expert", 10L, 5L, 100L
        );
        SimilarProjectWebResponse webResponse2 = new SimilarProjectWebResponse(
                3L, "Similar Project 2", "Content 2", 2L, "User 2", "profile2.jpg", "thumb2.jpg",
                "AI", "Research", "Public", "Expert", 20L, 10L, 200L
        );
        ...
        mockMvc.perform(get("/api/v1/projects/{projectId}/similar", projectId)
                ...
                .andExpect(jsonPath("$.message").value(ProjectSuccessStatus.FIND_SIMILAR_PROJECTS.getMessage()))
    ...
    void searchFilteredProjectsSuccess() throws Exception {
        ...
        FilteredProjectResponse response1 = new FilteredProjectResponse(
                1L, "Filtered Project 1", "Content 1", 1L, "User 1", "profile1.jpg", "thumb1.jpg",
                "AI", "Research", "Public", "Expert", 10L, 5L, 100L, LocalDateTime.now(), List.of()
        );
        FilteredProjectResponse response2 = new FilteredProjectResponse(
        ...
        Page<FilteredProjectResponse> responsePage = new PageImpl<>(List.of(response1, response2), pageable, 2);

        FilteredProjectWebResponse webResponse1 = new FilteredProjectWebResponse(
                1L, "Filtered Project 1", "Content 1", 1L, "User 1", "profile1.jpg", "thumb1.jpg",
                "AI", "Research", "Public", "Expert", 10L, 5L, 100L, LocalDateTime.now(), List.of()
        );
        FilteredProjectWebResponse webResponse2 = new FilteredProjectWebResponse(
                2L, "Filtered Project 2", "Content 2", 2L, "User 2", "profile2.jpg", "thumb2.jpg",
                "DATA", "Research", "Public", "Expert", 20L, 10L, 200L, LocalDateTime.now(), List.of()
        );
        ...
        mockMvc.perform(get("/api/v1/projects/filter")
                ...
                .andExpect(jsonPath("$.message").value(ProjectSuccessStatus.FIND_FILTERED_PROJECTS.getMessage()))
