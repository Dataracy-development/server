...
class ProjectFilterWebMapperTest {
  ...
  @Mock private ChildProjectWebMapper childProjectWebMapper;

  @InjectMocks private ProjectFilterWebMapper mapper;
  ...
  void toApplicationDto() {
    ...
    FilteringProjectWebRequest webRequest =
        new FilteringProjectWebRequest("keyword", "LATEST", 1L, 2L, 3L, 4L);
  ...
  void toWebDto() {
    ...
    FilteredProjectResponse responseDto =
        new FilteredProjectResponse(
            ...
            12L,
            13L,
            LocalDateTime.of(2025, 8, 27, 10, 0),
            List.of(childProjectResponse));

    ChildProjectWebResponse mappedChild =
        new ChildProjectWebResponse(
            100L, "child-title", "child-content", 1L, "child-user", "https://~~", 5L, 6L);
