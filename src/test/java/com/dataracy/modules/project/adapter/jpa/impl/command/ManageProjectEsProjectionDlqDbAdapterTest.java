...
class ManageProjectEsProjectionDlqDbAdapterTest {
  ...
  @InjectMocks private ManageProjectEsProjectionDlqDbAdapter adapter;

  @Mock private ProjectEsProjectionDlqRepository repo;

  @Captor private ArgumentCaptor<ProjectEsProjectionDlqEntity> captor;
