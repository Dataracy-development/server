...
class ProjectCommandControllerTest {
    ...
    void uploadProjectSuccess() throws Exception {
        ...
        UploadProjectWebRequest webRequest = new UploadProjectWebRequest(
                "Test Project",
                1L, // topicId
        ...
        UploadProjectRequest requestDto = new UploadProjectRequest(
                "Test Project",
                1L, // topicId
                2L, // analysisPurposeId
                3L, // dataSourceId
        ...
        given(uploadProjectUseCase.uploadProject(userId, thumbnailFile, requestDto)).willReturn(responseDto);
    ...
    void modifyProjectSuccess() throws Exception {
        ...
        ModifyProjectWebRequest webRequest = new ModifyProjectWebRequest(
                "Modified Project",
                1L, // topicId
                2L, // analysisPurposeId
                3L, // dataSourceId
        ...
        ModifyProjectRequest requestDto = new ModifyProjectRequest(
                "Modified Project",
                1L, // topicId
                2L, // analysisPurposeId
                3L, // dataSourceId
