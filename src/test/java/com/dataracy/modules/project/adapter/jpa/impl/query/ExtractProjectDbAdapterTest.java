...
class ExtractProjectDbAdapterTest {
  ...
  @Mock private ProjectDataJpaRepository projectDataJpaRepository;

  @InjectMocks private ExtractProjectDbAdapter adapter;
  ...
  class FindUserIdByProjectId {
    ...
    void failNotFound() {
      ...
      // when
      ProjectException ex =
          catchThrowableOfType(() -> adapter.findUserIdByProjectId(99L), ProjectException.class);
    ...
    void failNotFound() {
      ...
      ProjectException ex =
          catchThrowableOfType(
              () -> adapter.findUserIdIncludingDeleted(100L), ProjectException.class);
  ...
  class FindDataIdsByProjectId {
    ...
    void success() {
      // given
      given(projectDataJpaRepository.findDataIdsByProjectId(1L)).willReturn(Set.of(10L, 20L));
    ...
    void empty() {
      // given
      given(projectDataJpaRepository.findDataIdsByProjectId(2L)).willReturn(Set.of());
