...
class ProjectUserTest {
  ...
  class ProjectUserCreation {
    ...
    void createProjectUserWithConstructorSuccess() {
      ...
      ProjectUser projectUser =
          new ProjectUser(
              1L, RoleType.ROLE_USER, "user@test.com", "testUser", "profile.jpg", "안녕하세요", 1L, 2L);
    ...
    void createProjectUserWithNullValuesSuccess() {
      // when
      ProjectUser projectUser = new ProjectUser(null, null, null, null, null, null, null, null);
    ...
    void createProjectUserWithAdminRoleSuccess() {
      ...
      ProjectUser projectUser =
          new ProjectUser(
              999L, RoleType.ROLE_ADMIN, "admin@test.com", "admin", "admin.jpg", "관리자입니다", 3L, 4L);
  ...
  class FromUserInfoConversion {
    ...
    void fromUserInfoWithNullThrowsExceptionAndLogs() {
      ...
      ProjectException exception =
          catchThrowableOfType(() -> ProjectUser.fromUserInfo(null), ProjectException.class);
      assertAll(
          () -> assertThat(exception).isNotNull(),
          () ->
              assertThat(exception.getErrorCode())
                  .isEqualTo(ProjectErrorStatus.FAIL_GET_USER_INFO));
  ...
  class ProjectUserRecordCharacteristics {
    ...
    void projectUserNotEqualsTest() {
      ...
      ProjectUser projectUser2 =
          new ProjectUser(
              2L, RoleType.ROLE_USER, "user@test.com", "testUser", "profile.jpg", "안녕하세요", 1L, 2L);
