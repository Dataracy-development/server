...
class ProjectSuccessStatusTest {
  ...
  void projectSuccessStatusesShouldHaveCorrectHttpStatus() {
    ...
    assertAll(
        () ->
            assertThat(ProjectSuccessStatus.CREATED_PROJECT.getHttpStatus())
                .isEqualTo(HttpStatus.CREATED),
        () ->
            assertThat(ProjectSuccessStatus.FIND_REAL_TIME_PROJECTS.getHttpStatus())
                .isEqualTo(HttpStatus.OK),
        () ->
            assertThat(ProjectSuccessStatus.FIND_SIMILAR_PROJECTS.getHttpStatus())
                .isEqualTo(HttpStatus.OK),
        () ->
            assertThat(ProjectSuccessStatus.FIND_POPULAR_PROJECTS.getHttpStatus())
                .isEqualTo(HttpStatus.OK),
        () ->
            assertThat(ProjectSuccessStatus.FIND_FILTERED_PROJECTS.getHttpStatus())
                .isEqualTo(HttpStatus.OK),
        () ->
            assertThat(ProjectSuccessStatus.GET_PROJECT_DETAIL.getHttpStatus())
                .isEqualTo(HttpStatus.OK),
        () ->
            assertThat(ProjectSuccessStatus.MODIFY_PROJECT.getHttpStatus())
                .isEqualTo(HttpStatus.OK),
        () ->
            assertThat(ProjectSuccessStatus.DELETE_PROJECT.getHttpStatus())
                .isEqualTo(HttpStatus.OK));
  }
  ...
  void projectSuccessStatusesShouldHaveCorrectMessage() {
    ...
    assertAll(
        ...
        () ->
            assertThat(ProjectSuccessStatus.FIND_REAL_TIME_PROJECTS.getMessage())
                .contains("실시간 프로젝트 리스트를 조회하였습니다"),
        () ->
            assertThat(ProjectSuccessStatus.FIND_SIMILAR_PROJECTS.getMessage())
                .contains("유사 프로젝트 리스트를 조회하였습니다"),
        () ->
            assertThat(ProjectSuccessStatus.FIND_POPULAR_PROJECTS.getMessage())
                .contains("인기있는 프로젝트 리스트를 조회하였습니다"),
        () ->
            assertThat(ProjectSuccessStatus.FIND_FILTERED_PROJECTS.getMessage())
                .contains("필터링된 프로젝트 리스트를 조회하였습니다"),
        () ->
            assertThat(ProjectSuccessStatus.GET_PROJECT_DETAIL.getMessage())
                .contains("프로젝트 상세 정보를 조회하였습니다"),
        () ->
            assertThat(ProjectSuccessStatus.MODIFY_PROJECT.getMessage())
                .contains("프로젝트 수정이 완료되었습니다"),
        () ->
            assertThat(ProjectSuccessStatus.DELETE_PROJECT.getMessage())
                .contains("프로젝트 삭제가 완료되었습니다"));
  }
}
