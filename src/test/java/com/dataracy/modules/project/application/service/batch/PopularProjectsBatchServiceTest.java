...
class PopularProjectsBatchServiceTest {
  ...
  @InjectMocks private PopularProjectsBatchService popularProjectsBatchService;
  ...
  class UpdatePopularProjectsCache {
    ...
    void updatePopularProjectsCacheSuccess() {
      ...
      PopularProjectResponse response1 =
          new PopularProjectResponse(
              ...
              10L,
              15L);
      PopularProjectResponse response2 =
          new PopularProjectResponse(
              2L,
              "Test Project",
              "Test Content",
    ...
    void updatePopularProjectsCacheFailure() {
      ...
      willThrow(new RuntimeException("Database error"))
          .given(getPopularProjectsPort)
          .getPopularProjects(20);
