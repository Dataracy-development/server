...
class FilteredProjectDtoMapperTest {
  ...
  void toResponseDtoSuccessWithChildUsernames() {
    ...
    Map<Long, String> childUsernames = Map.of(201L, "child-user-1");

    Map<Long, String> childUserProfileUrls = Map.of(201L, "https://~~");

    // when
    FilteredProjectResponse response =
    ...
    // 자식 프로젝트 매핑 확인
    assertAll(() -> assertThat(response.childProjects()).hasSize(2));
