...
class OtherUserReadWebMapperTest {
  ...
  void toWebDto_userInfo_success() {
    ...
    GetOtherUserProjectResponse project =
        new GetOtherUserProjectResponse(
            3L, "Proj", "내용", "thumb.png", "주제", "레벨", 1L, 2L, 3L, LocalDateTime.now());
    GetOtherUserDataResponse data =
        new GetOtherUserDataResponse(
            4L,
            "Data",
            "주제",
    ...
    GetOtherUserInfoResponse dto =
        new GetOtherUserInfoResponse(
            99L, "다른유저", "중급", "데이터 분석가", "profile.png", "소개합니다", projects, datasets);
