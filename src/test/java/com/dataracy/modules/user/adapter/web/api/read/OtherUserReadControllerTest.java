...
class OtherUserReadControllerTest {
    ...
    @MockBean
    private GetOtherUserInfoUseCase getOtherUserInfoUseCase;
    ...
    void getOtherUserInfoSuccess() throws Exception {
        ...
        GetOtherUserProjectResponse project1 = new GetOtherUserProjectResponse(
                1L, "Project 1", "Content 1", "AI", "Expert", "test1.jpg", 10L, 5L, 100L, LocalDateTime.now()
        );
        GetOtherUserDataResponse data1 = new GetOtherUserDataResponse(
        ...
        GetOtherUserInfoResponse responseDto = new GetOtherUserInfoResponse(
                1L, "Test User", "Expert", "Developer", "profile.jpg", "Introduction", projectsPage, datasetsPage
        );

        GetOtherUserInfoWebResponse webResponse = new GetOtherUserInfoWebResponse(
                1L, "Test User", "Expert", "Developer", "profile.jpg", "Introduction", 
                new PageImpl<>(List.of(new GetOtherUserProjectWebResponse(1L, "Project 1", "Content 1", "AI", "Expert", "test1.jpg", 10L, 5L, 100L, LocalDateTime.now())), pageable, 1),
                new PageImpl<>(List.of(new GetOtherUserDataWebResponse(1L, "Data 1", "AI", "CSV", LocalDate.now(), LocalDate.now(), "thumb1.jpg", 10, 1024L, 100, 5, LocalDateTime.now(), 2L)), pageable, 1)
        );
    ...
    void getOtherUserProjectsSuccess() throws Exception {
        ...
        GetOtherUserProjectResponse project2 = new GetOtherUserProjectResponse(
                2L, "Project 2", "Content 2", "DATA", "Expert", "test2.jpg", 20L, 10L, 200L, LocalDateTime.now()
        );
        Page<GetOtherUserProjectResponse> responsePage = new PageImpl<>(List.of(project1, project2), pageable, 2);

        GetOtherUserProjectWebResponse webProject1 = new GetOtherUserProjectWebResponse(
                1L, "Project 1", "Content 1", "AI", "Expert", "test1.jpg", 10L, 5L, 100L, LocalDateTime.now()
        );
