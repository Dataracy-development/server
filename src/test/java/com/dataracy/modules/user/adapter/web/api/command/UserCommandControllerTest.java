...
@WebMvcTest(
    controllers = com.dataracy.modules.user.adapter.web.api.command.UseCommandController.class,
    includeFilters =
        @ComponentScan.Filter(
            ...
            classes = {
              ...
              com.dataracy.modules.common.config.web.MultipartJackson2HttpMessageConverter.class,
              com.dataracy.modules.common.config.web.WebMvcConfig.class
            }))
class UserCommandControllerTest {
  ...
  @MockBean private UserCommandWebMapper userCommandWebMapper;

  @MockBean private ModifyUserInfoUseCase modifyUserInfoUseCase;
  ...
  void setupResolver() {
    this.mockMvc =
        MockMvcBuilders.standaloneSetup(
                new com.dataracy.modules.user.adapter.web.api.command.UseCommandController(
  ...
  void modifyUserInfoSuccess() throws Exception {
    ...
    willDoNothing()
        .given(modifyUserInfoUseCase)
        .modifyUserInfo(userId, profileImageFile, requestDto);
  ...
  void logoutSuccess() throws Exception {
    ...
    // when & then
    mockMvc
        .perform(post("/api/v1/user/logout").cookie(new Cookie("refreshToken", refreshToken)))
        .andExpect(status().isOk())
