...
@WebMvcTest(controllers = com.dataracy.modules.user.adapter.web.api.read.UserReadController.class, includeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = {com.dataracy.modules.common.util.CookieUtil.class, com.dataracy.modules.common.support.resolver.CurrentUserIdArgumentResolver.class}))
class UserReadControllerTest {
    ...
    @MockBean
    private com.dataracy.modules.user.adapter.web.mapper.read.UserReadWebMapper userReadWebMapper;

    @MockBean
    private com.dataracy.modules.user.application.port.in.query.extractor.GetUserInfoUseCase getUserInfoUseCase;
