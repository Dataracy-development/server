...
class UserReadControllerTest {
    ...
    void getUserInfoSuccess() throws Exception {
        ...
        GetUserInfoResponse responseDto = new GetUserInfoResponse(
                1L, RoleType.ROLE_USER, "test@example.com", "Test User", 1L, "Expert", 2L, "Developer",
                List.of(1L, 2L), List.of("AI", "Data"), 3L, "Google", "profile.jpg", "Introduction"
        );

        GetUserInfoWebResponse webResponse = new GetUserInfoWebResponse(
                1L, RoleType.ROLE_USER, "test@example.com", "Test User", 1L, "Expert", 2L, "Developer",
                List.of(1L, 2L), List.of("AI", "Data"), 3L, "Google", "profile.jpg", "Introduction"
        );
