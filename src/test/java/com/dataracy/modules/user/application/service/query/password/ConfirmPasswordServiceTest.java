...
class ConfirmPasswordServiceTest {
  ...
  @InjectMocks private ConfirmPasswordService service;
  ...
  void confirmPassword_success() {
    ...
    // when & then
    assertThatCode(() -> service.confirmPassword(10L, req)).doesNotThrowAnyException();
  }
  ...
  void confirmPassword_userNotFound() {
    ...
    // when
    UserException ex =
        catchThrowableOfType(() -> service.confirmPassword(99L, req), UserException.class);
  ...
  void confirmPassword_passwordMismatch() {
    ...
    // when
    UserException ex =
        catchThrowableOfType(() -> service.confirmPassword(10L, req), UserException.class);
