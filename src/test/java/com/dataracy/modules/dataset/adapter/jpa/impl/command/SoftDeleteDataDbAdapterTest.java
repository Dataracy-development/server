...
class SoftDeleteDataDbAdapterTest {
  ...
  @InjectMocks private SoftDeleteDataDbAdapter adapter;
  ...
  class SoftDeleteData {
    ...
    void deleteDataShouldThrowWhenNotFound() {
      ...
      // when & then
      DataException ex = catchThrowableOfType(() -> adapter.deleteData(99L), DataException.class);
  ...
  class RestoreData {
    ...
    void restoreDataShouldThrowWhenNotFound() {
      ...
      // when & then
      DataException ex = catchThrowableOfType(() -> adapter.restoreData(99L), DataException.class);
