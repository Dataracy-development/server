...
class DataTest {
    ...
    void createDataWithOfMethod() {
        ...
        DataMetadata metadata = DataMetadata.of(
                1L, 1000, 10, "{\"preview\": \"테스트 데이터 미리보기\"}"
        );

        // when
        Data data = Data.of(
                1L, "테스트 데이터셋", 1L, 1L, 1L, 1L,
                startDate, endDate, "데이터셋 설명", "분석 가이드",
                "dataFile.csv", "thumbnail.jpg", 100, 1024L, metadata, createdAt
        );
    ...
    void createDataWithBuilder() {
        ...
        LocalDateTime createdAt = LocalDateTime.now();
        DataMetadata metadata = DataMetadata.of(
                2L, 2000, 20, "{\"preview\": \"빌더 데이터 미리보기\"}"
        );
    ...
    void createDataWithNullMetadata() {
        ...
        Data data = Data.of(
                1L, "테스트 데이터셋", 1L, 1L, 1L, 1L,
                startDate, endDate, "데이터셋 설명", "분석 가이드",
                "dataFile.csv", "thumbnail.jpg", 100, 1024L, null, createdAt
        );
    ...
    void createDataWithNullDates() {
        ...
        LocalDateTime createdAt = LocalDateTime.now();
        DataMetadata metadata = DataMetadata.of(
                3L, 500, 5, "{\"preview\": \"기본 데이터 미리보기\"}"
        );

        // when
        Data data = Data.of(
                1L, "테스트 데이터셋", 1L, 1L, 1L, 1L,
                null, null, "데이터셋 설명", "분석 가이드",
                "dataFile.csv", "thumbnail.jpg", 100, 1024L, metadata, createdAt
        );
