...
class DataEsProjectionTypeTest {
  ...
  void dataEsProjectionTypeShouldHaveCorrectValues() {
    // Given & When & Then
    assertAll(
  ...
  void dataEsProjectionTypeShouldHaveCorrectNames() {
    // Given & When & Then
    assertAll(
  ...
  void dataEsProjectionTypeShouldParseFromString() {
    // Given & When & Then
    assertAll(
        () ->
            assertThat(DataEsProjectionType.valueOf("PENDING"))
                .isEqualTo(DataEsProjectionType.PENDING),
        () ->
            assertThat(DataEsProjectionType.valueOf("RETRYING"))
                .isEqualTo(DataEsProjectionType.RETRYING));
  }

  @Test
  @DisplayName("DataEsProjectionType ordinal() 메서드 테스트")
  void dataEsProjectionTypeShouldHaveCorrectOrdinals() {
    // Given & When & Then
    assertAll(
  ...
  void dataEsProjectionTypeShouldHaveCorrectToString() {
    // Given & When & Then
    assertAll(
