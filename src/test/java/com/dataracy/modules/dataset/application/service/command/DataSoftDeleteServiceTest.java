...
class DataSoftDeleteServiceTest {
  ...
  @InjectMocks private DataSoftDeleteService service;

  @Mock private SoftDeleteDataPort softDeleteDataDbPort;
  ...
  class DeleteData {
    ...
    void deleteDataFailProjectionTaskFailure() {
      ...
      willThrow(new RuntimeException("프로젝션 작업 등록 실패"))
          .given(manageDataProjectionTaskPort)
          .enqueueSetDeleted(dataId, true);
  ...
  class RestoreData {
    ...
    void restoreDataFailProjectionTaskFailure() {
      ...
      willThrow(new RuntimeException("프로젝션 작업 등록 실패"))
          .given(manageDataProjectionTaskPort)
          .enqueueSetDeleted(dataId, false);
