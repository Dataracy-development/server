...
class DataLabelMapServiceTest {
  ...
  @InjectMocks private DataLabelMapService service;

  @Mock private FindUsernameUseCase userCase;

  @Mock private FindUserThumbnailUseCase findUserThumbnailUseCase;

  @Mock private GetTopicLabelFromIdUseCase topicCase;

  @Mock private GetDataSourceLabelFromIdUseCase dsCase;

  @Mock private GetDataTypeLabelFromIdUseCase dtCase;
