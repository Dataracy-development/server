...
class DataReadServiceTest {
    ...
    @Mock
    private GetRecentDataSetsPort getRecentDataSetsPort;

    @Mock
    private FindDataWithMetadataPort findDataWithMetadataPort;
    ...
    @Mock
    private GetDataSourceLabelFromIdUseCase dsUseCase;

    @Mock
    private GetDataTypeLabelFromIdUseCase dtUseCase;

    @Mock
    private GetAuthorLevelLabelFromIdUseCase authorUseCase;

    @Mock
    private GetOccupationLabelFromIdUseCase occUseCase;
    ...
    class DataSetDetail {
        ...
        void getDataDetailSuccess() {
            // given
            Data d = sample();
            given(findDataWithMetadataPort.findDataWithMetadataById(1L))
                    .willReturn(Optional.of(d));

            UserInfo info = new UserInfo(
                    3L, RoleType.ROLE_USER, "e", "nick",
                    1L, 2L, List.of(), null, "p", "intro"
            );
