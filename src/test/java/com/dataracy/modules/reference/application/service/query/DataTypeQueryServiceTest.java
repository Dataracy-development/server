...
class DataTypeQueryServiceTest {
  ...
  @Mock private DataTypeDtoMapper dataTypeDtoMapper;

  @InjectMocks private DataTypeQueryService service;
  ...
  void findAllDataTypesSuccess() {
    ...
    AllDataTypesResponse mapped =
        new AllDataTypesResponse(
            List.of(new DataTypeResponse(1L, "v1", "l1"), new DataTypeResponse(2L, "v2", "l2")));
  ...
  void findDataTypeFailWhenNotFound() {
    ...
    ReferenceException ex =
        catchThrowableOfType(() -> service.findDataType(id), ReferenceException.class);
  ...
  void validateDataTypeFailWhenNotFound() {
    ...
    // when
    ReferenceException ex =
        catchThrowableOfType(() -> service.validateDataType(id), ReferenceException.class);
