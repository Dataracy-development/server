...
@WebMvcTest(
    controllers = DataSourceController.class,
    includeFilters =
...
class DataSourceControllerTest {
  ...
  @MockBean private FindAllDataSourcesUseCase findAllDataSourcesUseCase;

  @MockBean private DataSourceWebMapper webMapper;
  ...
  void findAllDataSourcesSuccess() throws Exception {
    ...
    AllDataSourcesWebResponse web =
        new AllDataSourcesWebResponse(
            List.of(
    ...
    // when & then
    mockMvc
        .perform(get("/api/v1/references/data-sources").accept(MediaType.APPLICATION_JSON))
