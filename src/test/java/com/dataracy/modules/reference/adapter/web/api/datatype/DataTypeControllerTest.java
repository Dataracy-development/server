...
class DataTypeControllerTest {
  ...
  @MockBean private FindAllDataTypesUseCase findAllDataTypesUseCase;

  @MockBean private DataTypeWebMapper webMapper;
  ...
  void findAllDataTypesSuccess() throws Exception {
    ...
    AllDataTypesWebResponse web =
        new AllDataTypesWebResponse(
            List.of(
    ...
    // when & then
    mockMvc
        .perform(get("/api/v1/references/data-types").accept(MediaType.APPLICATION_JSON))
