...
@WebMvcTest(
    controllers = AnalysisPurposeController.class,
    includeFilters =
...
class AnalysisPurposeControllerTest {
  ...
  @MockBean private FindAllAnalysisPurposesUseCase findAllAnalysisPurposesUseCase;

  @MockBean private AnalysisPurposeWebMapper webMapper;
  ...
  void findAllAnalysisPurposesSuccess() throws Exception {
    ...
    // when & then
    mockMvc
        .perform(get("/api/v1/references/analysis-purposes").accept(MediaType.APPLICATION_JSON))
