...
@WebMvcTest(controllers = VisitSourceController.class, includeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = {com.dataracy.modules.common.util.CookieUtil.class, com.dataracy.modules.common.support.resolver.CurrentUserIdArgumentResolver.class}))
class VisitSourceControllerTest {
    ...
    // ===== MockBean =====
    @MockBean
    private FindAllVisitSourcesUseCase findAllVisitSourcesUseCase;

    @MockBean
    private VisitSourceWebMapper webMapper;
    ...
    void findAllVisitSourcesSuccess() throws Exception {
        ...
        AllVisitSourcesWebResponse web = new AllVisitSourcesWebResponse(
                List.of(new VisitSourceWebResponse(1L, "GOOGLE", "구글 검색"))
        );
