...
class FileUtilTest {
  ...
  void validateImageFileShouldPassForValidImageFile() {
    ...
    MockMultipartFile file =
        new MockMultipartFile("file", "test.jpg", "image/jpeg", smallImageData);
  ...
  void validateImageFileShouldAcceptValidExtensions() {
    ...
    MockMultipartFile jpegFile =
        new MockMultipartFile("file", "test.jpeg", "image/jpeg", smallData);
    MockMultipartFile pngFile = new MockMultipartFile("file", "test.png", "image/png", smallData);
  ...
  void validateGeneralFileShouldAcceptValidExtensions() {
    ...
    MockMultipartFile jsonFile =
        new MockMultipartFile("file", "test.json", "application/json", smallData);
