...
class CommentAuthPolicyAspectTest {
  ...
  @Mock private FindUserIdByCommentIdUseCase findUserIdByCommentIdUseCase;

  @Mock private AuthorizationCommentEdit annotation;

  @InjectMocks private CommentAuthPolicyAspect commentAuthPolicyAspect;
