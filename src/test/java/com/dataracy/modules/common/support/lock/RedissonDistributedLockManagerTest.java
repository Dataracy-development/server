...
class RedissonDistributedLockManagerTest {
    ...
    class ExecuteTest {
        ...
        void execute_BusinessException_그대로전파() throws Exception {
            ...
            BusinessException businessException = new BusinessException(com.dataracy.modules.common.status.CommonErrorStatus.BAD_REQUEST) {
        ...
        void execute_CommonException_그대로전파() throws Exception {
            ...
            CommonException commonException = new CommonException(com.dataracy.modules.common.status.CommonErrorStatus.DATA_ACCESS_EXCEPTION);
            Supplier<String> action = () -> {
