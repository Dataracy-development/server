  ...
  class BusinessExceptionHandlingTest {
    ...
    void successhandleBusinessException() {
      ...
      ResponseEntity<ErrorResponse> response =
          exceptionHandler.handleCustomException(dataException);
      ...
      assertAll(
          ...
          () ->
              assertThat(response.getBody().getCode())
                  .isEqualTo(DataErrorStatus.NOT_FOUND_DATA.getCode()),
          () ->
              assertThat(response.getBody().getMessage())
                  .isEqualTo(DataErrorStatus.NOT_FOUND_DATA.getMessage()));
    }
    ...
    void successhandleCommonException() {
      ...
      try (MockedStatic<com.dataracy.modules.common.logging.support.LoggerFactory>
          mockedLoggerFactory =
        ...
        mockedLoggerFactory
            .when(com.dataracy.modules.common.logging.support.LoggerFactory::common)
            .thenReturn(mockLogger);

        // when
        ResponseEntity<ErrorResponse> response =
            exceptionHandler.handleCommonException(commonException);
        ...
        assertAll(
            ...
            () ->
                assertThat(response.getBody().getCode())
                    .isEqualTo(CommonErrorStatus.INTERNAL_SERVER_ERROR.getCode()),
            () ->
                assertThat(response.getBody().getMessage())
                    .isEqualTo(CommonErrorStatus.INTERNAL_SERVER_ERROR.getMessage()));
    ...
    void successhandleLockAcquisitionException() {
      ...
      try (MockedStatic<com.dataracy.modules.common.logging.support.LoggerFactory>
        ...
        assertAll(
            ...
            () ->
                assertThat(response.getBody().getCode())
                    .isEqualTo(CommonErrorStatus.CONFLICT.getCode()),
  ...
  class SecurityExceptionHandlingTest {
    ...
    void successhandleSecurityException() {
      ...
      try (MockedStatic<com.dataracy.modules.common.logging.support.LoggerFactory>
        ...
        // when
        ResponseEntity<ErrorResponse> response =
            exceptionHandler.handleSecurityException(securityException);
        ...
        assertAll(
            ...
            () ->
                assertThat(response.getBody().getCode())
                    .isEqualTo(CommonErrorStatus.UNAUTHORIZED.getCode()),
    ...
    void successhandleIllegalArgumentException() {
      ...
      try (MockedStatic<com.dataracy.modules.common.logging.support.LoggerFactory>
        ...
        assertAll(
            ...
            () ->
                assertThat(response.getBody().getCode())
                    .isEqualTo(CommonErrorStatus.BAD_REQUEST.getCode()),
            () -> assertThat(response.getBody().getMessage()).isEqualTo("잘못된 인자"));

        verify(mockLogger)
            .logError("IllegalArgumentException", "잘못된 인자가 전달되었습니다.", illegalArgException);
      }
    }
  }
  ...
  class OtherExceptionHandlingTest {
    ...
    void successhandleNullPointerException() {
      ...
      try (MockedStatic<com.dataracy.modules.common.logging.support.LoggerFactory>
        ...
        verify(mockLogger)
            .logError("NullPointerException", "요청을 처리하는 중에 Null 값이 참조되었습니다.", nullPointerException);
      }
    }
    ...
    void successhandleNumberFormatException() {
      ...
      try (MockedStatic<com.dataracy.modules.common.logging.support.LoggerFactory>
        ...
        // when
        ResponseEntity<ErrorResponse> response =
            exceptionHandler.handleNumberFormatException(numberFormatException);
        ...
        verify(mockLogger)
            .logError("NumberFormatException", "숫자 형식이 잘못되었습니다.", numberFormatException);
      }
    }
    ...
    void successhandleIndexOutOfBoundsException() {
      ...
      try (MockedStatic<com.dataracy.modules.common.logging.support.LoggerFactory>
        ...
        // when
        ResponseEntity<ErrorResponse> response =
            exceptionHandler.handleIndexOutOfBoundsException(indexOutOfBoundsException);
        ...
        verify(mockLogger)
            .logError("IndexOutOfBoundsException", "인덱스가 범위를 벗어났습니다.", indexOutOfBoundsException);
      }
    }
  }
