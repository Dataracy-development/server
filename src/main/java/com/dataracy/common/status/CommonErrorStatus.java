...
public enum CommonErrorStatus implements BaseErrorCode {
    ...
    // Redis Errors
    FAILED_SAVE_REFRESH_TOKEN_IN_REDIS(HttpStatus.INTERNAL_SERVER_ERROR, "REDIS-001", "리프레시 토큰의 Redis 저장에 실패했습니다."),
    REFRESH_TOKEN_NOT_FOUND_IN_REDIS(HttpStatus.NOT_FOUND, "REDIS-002", "Redis에서 해당 유저의 리프레시 토큰을 찾을 수 없습니다."),
    REFRESH_TOKEN_USER_MISMATCH_IN_REDIS(HttpStatus.UNAUTHORIZED, "REDIS-003", "제공받은 리프레시토큰과 Redis의 리프레시토큰이 일치하지 않습니다."),
