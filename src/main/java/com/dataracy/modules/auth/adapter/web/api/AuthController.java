...
public class AuthController implements AuthApi {
    ...
    /**
     * 자체 로그인 요청을 처리하고, 성공 시 리프레시 토큰을 쿠키에 저장한다.
     *
     * 사용자의 이메일과 비밀번호로 자체 로그인을 수행하며, 인증에 성공하면 리프레시 토큰을 HTTP 응답 쿠키로 설정한다.
     *
    ...
    /**
     * 리프레시 토큰을 이용해 새로운 액세스 토큰과 리프레시 토큰을 발급하고, 해당 토큰 정보를 쿠키에 저장합니다.
     *
     * @param refreshToken 클라이언트가 제공한 리프레시 토큰
     * @param response 토큰 정보를 쿠키로 설정할 HTTP 응답 객체
     * @return 토큰 재발급이 성공하면 성공 상태의 응답을 반환합니다.
     */
    @Override
