...
public enum TokenType {
   ...
   *
   * <p>입력값이 "REGISTER", "ACCESS", "REFRESH", "RESET_PASSWORD" 중 하나와 일치하지 않으면 규칙 위반을 로그로 남기고
   * AuthException을 발생시킵니다.
   *
        ...
        .orElseThrow(
            () -> {
              LoggerFactory.domain()
                  .logRuleViolation(
                      "TokenType",
                      "잘못된 ENUM 타입입니다. REGISTER, ACCESS, REFRESH, RESET_PASSWORD만 가능합니다.");
