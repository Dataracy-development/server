...
public enum AuthErrorStatus implements BaseErrorCode {
    ...
    // 토큰 검증 실패
    INVALID_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH-009", "토큰이 유효하지 않습니다."),
    INVALID_ACCESS_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH-010", "유효하지 않은 액세스 토큰입니다."),
    INVALID_REFRESH_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH-011", "유효하지 않은 리프레시 토큰입니다."),
    INVALID_REGISTER_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH-012", "유효하지 않은 레지스터 토큰입니다."),

    // Redis 및 일치 오류
    REFRESH_TOKEN_USER_MISMATCH_IN_REDIS(HttpStatus.UNAUTHORIZED, "AUTH-013", "Redis의 리프레시 토큰과 일치하지 않습니다."),

    // 토큰 생성 실패
    FAILED_GENERATE_ACCESS_TOKEN(HttpStatus.INTERNAL_SERVER_ERROR, "AUTH-014", "액세스 토큰 생성에 실패했습니다."),
    FAILED_GENERATE_REFRESH_TOKEN(HttpStatus.INTERNAL_SERVER_ERROR, "AUTH-015", "리프레시 토큰 생성에 실패했습니다."),
    FAILED_GENERATE_REGISTER_TOKEN(HttpStatus.INTERNAL_SERVER_ERROR, "AUTH-016", "레지스터 토큰 생성에 실패했습니다."),
