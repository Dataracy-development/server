...
public final class AnalysisPurposeEntityMapper {
   ...
   *
   * <p>입력이 null이면 null을 반환합니다. 그렇지 않으면 도메인 모델의 value와 label 값을 사용하여 새로운 엔티티를 생성합니다.
   *
  ...
  public static AnalysisPurposeEntity toEntity(AnalysisPurpose analysisPurpose) {
    ...
    return AnalysisPurposeEntity.of(analysisPurpose.value(), analysisPurpose.label());
  }
}
