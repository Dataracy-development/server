    ...
    return switch (verificationType) {
      case SIGN_UP ->
          ResponseEntity.status(HttpStatus.OK)
              .body(SuccessResponse.of(EmailSuccessStatus.OK_SEND_EMAIL_CODE_SIGN_UP));
      case PASSWORD_SEARCH ->
          ResponseEntity.status(HttpStatus.OK)
              .body(SuccessResponse.of(EmailSuccessStatus.OK_SEND_EMAIL_CODE_PASSWORD_SEARCH));
      case PASSWORD_RESET ->
          ResponseEntity.status(HttpStatus.OK)
              .body(SuccessResponse.of(EmailSuccessStatus.OK_SEND_EMAIL_CODE_PASSWORD_RESET));
    };
  }
}
