...
public class EmailVerifyController implements EmailVerifyApi {
   ...
   */
  @Override
  public ResponseEntity<SuccessResponse<GetResetTokenResponse>> verifyCode(
    ...
    return ResponseEntity.status(HttpStatus.OK)
        .body(SuccessResponse.of(EmailSuccessStatus.OK_VERIFY_EMAIL_CODE, resetPasswordToken));
  }
}
