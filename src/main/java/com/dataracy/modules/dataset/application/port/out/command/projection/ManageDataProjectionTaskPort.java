 ...
 *
 * 데이터 식별자에 해당하는 투영 엔티티의 `deleted` 플래그를 변경하도록 비동기 작업을 생성하여
 * 처리 큐에 넣는다.
 *
 ...
 *
 * 지정한 데이터 식별자에 대해 증분(delta)을 다운로드하거나 적용하는 비동기 작업을 등록한다.
 *
 ...
 *
 * 주어진 식별자에 해당하는 데이터 Elasticsearch 프로젝션 작업(큐 항목 또는 영속화된 작업 레코드)을 제거합니다.
 *
