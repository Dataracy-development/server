 ...
 *
 * <p>각 페이지 항목은 데이터셋 정보와 해당 데이터셋이 연결된 프로젝트 수를 포함한
 * DataWithProjectCountDto로 구성됩니다.</p>
 *
 ...
 *
 * <p>입력한 ID들에 해당하는 데이터셋 각각에 대해 DataWithProjectCountDto(데이터셋 정보 + 연결된 프로젝트 수)를 포함한 리스트를 반환합니다.
