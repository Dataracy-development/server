...
public class DataDatePredicate {
  ...
  public static BooleanExpression yearBetween(Integer year) {
    ...
    NumberTemplate<Integer> startYear =
        Expressions.numberTemplate(Integer.class, "year({0})", data.startDate);
    NumberTemplate<Integer> endYear =
        Expressions.numberTemplate(Integer.class, "year({0})", data.endDate);
