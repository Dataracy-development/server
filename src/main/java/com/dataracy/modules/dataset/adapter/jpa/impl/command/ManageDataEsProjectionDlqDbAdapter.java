...
public class ManageDataEsProjectionDlqDbAdapter implements ManageDataProjectionDlqPort {
   ...
   *
   * <p>주어진 식별자와 상태 정보를 사용해 DataEsProjectionDlqEntity를 생성한 뒤 저장소에 저장한다.
   *
   ...
   */
  @Override
  public void save(Long dataId, Integer deltaDownload, Boolean setDeleted, String lastError) {
    dlqRepo.save(
        DataEsProjectionDlqEntity.builder()
            .dataId(dataId)
