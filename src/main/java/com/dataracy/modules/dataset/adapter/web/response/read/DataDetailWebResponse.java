...
public record DataDetailWebResponse(
    ...
    @Schema(description = "유저 소개글", example = "안녕하세요. 주니입니다.") String userIntroductionText,
    @Schema(description = "작성자 유형 라벨", example = "실무자") String authorLabel,
    @Schema(description = "직업 라벨", example = "학생") String occupationLabel,
