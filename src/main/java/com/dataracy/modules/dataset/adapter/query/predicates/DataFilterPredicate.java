...
public class DataFilterPredicate {
    /****
 * DataFilterPredicate 클래스의 인스턴스 생성을 방지하기 위한 private 생성자입니다.
 */
private DataFilterPredicate() {}
    ...
    /**
     * 주어진 topicId와 일치하는 데이터 엔터티의 topicId를 검사하는 QueryDSL 조건식을 반환합니다.
     *
     * @param topicId 필터링할 토픽 ID
     * @return topicId가 일치하는 경우의 BooleanExpression, topicId가 null이면 null 반환
     */
     ...
     *
     * @param dataTypeId 데이터 타입 ID (null일 경우 조건식이 생성되지 않습니다)
