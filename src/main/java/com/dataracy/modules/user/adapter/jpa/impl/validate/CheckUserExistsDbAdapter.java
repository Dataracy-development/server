...
public class CheckUserExistsDbAdapter implements ValidateUserExistsPort {
    ...
    public boolean existsByNickname(String nickname) {
        ...
        LoggerFactory.db().logExist(USER_ENTITY, "[existsByNickname] 해당 닉네임에 해당하는 유저가 존재하는지 유무를 확인하였습니다. nickname=" + nickname);
        return exists;
    }
    ...
    public boolean existsByEmail(String email) {
        ...
        LoggerFactory.db().logExist(USER_ENTITY, "[existsByEmail] 해당 이메일에 해당하는 유저가 존재하는지 유무를 확인하였습니다. email=" + email);
        return exists;
    }
}
