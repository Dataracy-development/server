...
public interface UserValidateApi {
   ...
   *
   * <p>요청된 닉네임이 이미 존재하는지 검사하여, 중복이 없으면 200 OK를 반환합니다. 닉네임이 중복된 경우 409 Conflict 상태 코드로 응답합니다.
   *
  ...
  ResponseEntity<SuccessResponse<Void>> duplicateNickname(
      @io.swagger.v3.oas.annotations.parameters.RequestBody(
              ...
              content =
                  @Content(schema = @Schema(implementation = DuplicateNicknameWebRequest.class)))
          @Validated
          @RequestBody
