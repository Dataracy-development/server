...
public enum ProviderType {
   ...
   *
   * <p>입력값이 열거형의 value 또는 이름과(대소문자 구분 없이) 일치할 경우 해당 ProviderType을 반환합니다. 일치하는 값이 없으면 로그를 남기고
   * UserException(UserErrorStatus.INVALID_PROVIDER_TYPE)을 발생시킵니다.
   *
        ...
        .orElseThrow(
            () -> {
              LoggerFactory.domain()
                  .logRuleViolation("ProviderType", "잘못된 ENUM 타입입니다. LOCAL, KAKAO, GOOGLE만 가능합니다.");
