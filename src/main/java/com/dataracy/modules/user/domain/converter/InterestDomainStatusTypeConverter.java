...
public class InterestDomainStatusTypeConverter {

    public static InterestDomainStatusType of(String input) {
        ...
        return Arrays.stream(InterestDomainStatusType.values())
                ...
                .findFirst()
                .orElseThrow(() -> new UserException(UserErrorStatus.BAD_REQUEST_DOMAIN_TOPIC_STATUS_TYPE));
    }
}
