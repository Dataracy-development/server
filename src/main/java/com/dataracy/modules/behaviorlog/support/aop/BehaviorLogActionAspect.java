...
public class BehaviorLogActionAspect {
     ...
     *
     * 클릭 액션 값이 비어 있으면 기본값 "CLICK"이 사용됩니다.
     */
     ...
     *
     * 사용자의 이전 경로와 머문 시간을 Redis에서 조회하여 계산하고, 현재 경로 및 타임스탬프를 Redis에 10분간 저장합니다.
     * MDC에는 액션 타입, 이전 경로(REFERRER), 다음 경로(NEXT_PATH), 머문 시간(STAY_TIME) 정보를 추가합니다.
     * Redis에 저장된 타임스탬프가 잘못된 경우 경고 로그를 남깁니다.
     */
