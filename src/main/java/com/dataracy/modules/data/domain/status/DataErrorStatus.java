...
public enum DataErrorStatus implements BaseErrorCode {
    ...
    FAIL_SIMILAR_SEARCH_DATA(HttpStatus.INTERNAL_SERVER_ERROR, "DATA-005", "유사 프로젝트 검색 실패"),
    INVALID_DATA_SORT_TYPE(HttpStatus.INTERNAL_SERVER_ERROR, "DATA-006", "데이터셋 정렬은 LATEST, OLDEST, DOWNLOAD, UTILIZE 만 가능합니다."),
    ;
