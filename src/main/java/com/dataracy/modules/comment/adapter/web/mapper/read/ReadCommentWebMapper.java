...
public class ReadCommentWebMapper {
   ...
   * @return 댓글 ID, 작성자 정보, 프로필 이미지 URL, 작성자 레벨 레이블, 내용, 좋아요 수, 대댓글 수, 생성 시각 및 좋아요 여부를 포함한 웹 계층 댓글
   *     응답 객체
   */
   ...
   *
   * <p>매핑되는 필드: id, creatorId, creatorName, authorLevelLabel, userProfileUrl, content, likeCount,
   * createdAt, isLiked.
   *
