...
public enum CommentErrorStatus implements BaseErrorCode {
    ...
    FORBIDDEN_REPLY_COMMENT(HttpStatus.FORBIDDEN, "COMMENT-004", "답글에 다시 답글을 작성할 순 없습니다."),
    MISMATCH_PROJECT_COMMENT(HttpStatus.FORBIDDEN, "COMMENT-004", "해당 프로젝트에 작성된 댓글이 아닙니다."),
