...
public class LikeEntity extends BaseTimeEntity {
   ...
   */
  public static LikeEntity of(Long targetId, TargetType targetType, Long userId) {
    return LikeEntity.builder().targetId(targetId).targetType(targetType).userId(userId).build();
  }
}
