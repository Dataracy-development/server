...
public class Like {
   ...
   */
  public static Like of(Long id, Long targetId, TargetType targetType, Long userId) {
    return Like.builder().id(id).targetId(targetId).targetType(targetType).userId(userId).build();
  }
}
