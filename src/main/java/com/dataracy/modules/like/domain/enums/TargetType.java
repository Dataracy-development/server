...
public enum TargetType {
   ...
   *
   * <p>입력값이 TargetType의 value 또는 이름과 대소문자 구분 없이 일치하면 해당 enum 값을 반환합니다. 일치하는 값이 없을 경우
   * LikeException(INVALID_TARGET_TYPE)을 발생시킵니다.
   *
        ...
        .orElseThrow(
            () -> {
              LoggerFactory.domain()
                  .logRuleViolation("TargetType", "잘못된 ENUM 타입입니다. PROJECT, COMMENT만 가능합니다.");
