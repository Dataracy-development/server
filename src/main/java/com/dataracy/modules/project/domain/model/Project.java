...
public class Project {
  ...
  public List<Long> getDataIds() {
    return dataIds != null ? Collections.unmodifiableList(dataIds) : Collections.emptyList();
  }

  public List<Project> getChildProjects() {
    return childProjects != null
        ? Collections.unmodifiableList(childProjects)
   ...
   * @return 지정된 모든 속성 값이 반영된 Project 객체 참고: 16개의 파라미터를 가지지만, Project가 복잡한 도메인 모델이고 Builder 패턴을
   *     내부적으로 사용하므로 허용됩니다.
   */
