...
public enum ProjectErrorStatus implements BaseErrorCode {
    ...
    FAIL_REAL_TIME_SEARCH_PROJECT(HttpStatus.INTERNAL_SERVER_ERROR, "PROJECT-003", "프로젝트 자동완성 검색에 실패"),
    ...
    NOT_MATCH_CREATOR(HttpStatus.FORBIDDEN, "PROJECT-007", "작성자만 수정 및 삭제가 가능합니다."),
    ;
