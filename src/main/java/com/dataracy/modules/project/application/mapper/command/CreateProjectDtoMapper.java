...
public class CreateProjectDtoMapper {
   ...
   *
   * <p>프로젝트 ID는 null로 설정되어 신규 엔티티임을 나타내며, 프로젝트 이미지 URL은 기본값이 사용됩니다. 댓글, 좋아요, 조회수는 0으로 초기화되고, 삭제 여부는
   * false, 자식 프로젝트 리스트는 비어 있습니다.
   *
   ...
   */
  public Project toDomain(UploadProjectRequest requestDto, Long userId, Long parentProjectId) {
    return Project.of(
        null, // id는 생성 시 null
        requestDto.title(),
        requestDto.topicId(),
