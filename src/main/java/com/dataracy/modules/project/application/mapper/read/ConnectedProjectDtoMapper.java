...
public class ConnectedProjectDtoMapper {
   ...
   *
   * <p>Project의 식별자, 제목, 사용자 ID, 댓글/좋아요/조회수, 생성일자와 함께 전달된 username 및 topicLabel을 응답 DTO에 포함합니다.
   *
  ...
  public ConnectedProjectResponse toResponseDto(
      Project project, String username, String userProfileImageUrl, String topicLabel) {
