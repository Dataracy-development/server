 ...
 *
 * 등록되는 델타는 양수(증가) 또는 음수(감소)를 허용하며, 실제 프로젝션 반영은 비동기적으로 처리된다.
 *
 ...
 *
 * 프로젝트 식별자에 해당하는 엔티티의 조회수에 적용할 증감량(deltaView)을 큐에 기록하여
 * 이후 비동기 프로젝션 처리에서 반영되도록 한다.
 *
 ...
 *
 * 이 작업은 비동기적으로 처리될 projection 업데이트(삭제 상태 설정)를 예약한다.
 *
 * @param projectId 대상 프로젝트의 식별자
