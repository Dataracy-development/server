...
public class ContinuedProjectDtoMapper {
   ...
   *
   * <p>Project 객체의 id, title, userId, thumbnailUrl, commentCount, likeCount, viewCount, createdAt
   * 값을 사용하고, 추가로 전달된 username, userProfileUrl, topicLabel, authorLevelLabel을 응답 DTO에 포함합니다.
   *
   * @param project 변환할 Project 도메인 객체(사용되는 필드: id, title, userId, thumbnailUrl, commentCount,
