...
@Schema(description = "프로젝트 필터링 웹 응답 DTO")
public record FilteredProjectWebResponse(
    ...
    @Schema(description = "연결된 자식 프로젝트 리스트") List<ChildProjectWebResponse> childProjects) {}
