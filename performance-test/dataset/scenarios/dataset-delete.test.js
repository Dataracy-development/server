...
// k6 test for Dataset Delete (Soft Delete, 다중 삭제)
...
function scenarioExec() {
    // TODO: implement API call for Dataset Delete (Soft Delete, 다중 삭제)
    const url = `${BASE_URL}/api/v1/datasets?nocache=${Math.random()}`;
    const res = http.get(url, headers({ endpoint: 'delete' }));
