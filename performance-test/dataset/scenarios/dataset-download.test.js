// dataset-download.test.js
// k6 test for Get Presigned URL + Download
...
function scenarioExec() {
    // TODO: implement API call for Get Presigned URL + Download
    const url = `${BASE_URL}/api/v1/datasets?nocache=${Math.random()}`;
    const res = http.get(url, headers({ endpoint: 'download' }));
