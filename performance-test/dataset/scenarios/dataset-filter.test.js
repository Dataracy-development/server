// dataset-filter.test.js
// k6 test for Filtered Dataset Search
...
function scenarioExec() {
    // TODO: implement API call for Filtered Dataset Search
    const url = `${BASE_URL}/api/v1/datasets?nocache=${Math.random()}`;
    const res = http.get(url, headers({ endpoint: 'filter' }));
