// dataset-similar.test.js
// k6 test for Similar Dataset Search
...
function scenarioExec() {
    // TODO: implement API call for Similar Dataset Search
    const url = `${BASE_URL}/api/v1/datasets?nocache=${Math.random()}`;
    const res = http.get(url, headers({ endpoint: 'similar' }));
